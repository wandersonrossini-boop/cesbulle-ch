...
# Let's find exactly the beginning and end
start_marker = 'void _showRecurringExpensesModal() {'
end_marker = 'Future<void> _viewAttachment('

start_idx = content.find(start_marker)
end_idx = content.find(end_marker)

if start_idx != -1 and end_idx != -1:
    # Backtrack start_idx to the indentation if needed
    start_idx = content.rfind('  ', 0, start_idx)
    end_idx = content.rfind('  ', 0, end_idx)
    
    new_func = """  void _showRecurringExpensesModal() {
