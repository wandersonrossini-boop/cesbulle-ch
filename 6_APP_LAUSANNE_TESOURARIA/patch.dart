...
void main() {
  final file = File('c:/Users/Wande/Documents/ia/6_APP_LAUSANNE_TESOURARIA/tesouraria_cme_app/lib/presentation/pages/expenses_page.dart');
  var content = file.readAsStringSync();
  
  final startText = '  void _showRecurringExpensesManager() {';
  final endText = '  Future<void> _viewAttachment(';
  ...
  if (startIndex != -1 && endIndex != -1) {
    ...
    final newFunc = '''  void _showRecurringExpensesManager() {
...
'''
    ...
    content = content.replaceRange(startIndex, endIndex, newFunc);
